...
\hypersetup{
  pdftitle={  Demokratiske algoritmer   Legitimitet, rettferdighet, og representasjon: Fremtidsutsikter til automatiserte beslutningsprosesser i offentlig forvaltning i befolkningens øyne},
  pdfauthor={Sveinung Arnesen og Mikael Poul Johannesson},
  hidelinks,
...
\renewcommand{\listtablename}{Tabellliste}
...
\addcontentsline{toc}{section}{Om rapporten}

\hypertarget{forfattere}{%
\subsection*{Forfattere}\label{forfattere}}
\addcontentsline{toc}{subsection}{Forfattere}
...
\addcontentsline{toc}{subsection}{Referansegruppe}
...
\addcontentsline{toc}{subsection}{Finansiering}
...
\addcontentsline{toc}{subsection}{Sitering}
...
\addcontentsline{toc}{section}{Utvidet sammendrag}
