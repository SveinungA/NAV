...
Dette kapitlet har gitt oss oppdaterte data på innbyggere i Norges relasjon til NAV.
Vi ser at
...
I befolkningen for øvrig er det antatt lite kjennskap til maskinlæring og kunstig intelligens.
...
\caption{Kjennskap til maskinlæring}
\end{figure}

\hypertarget{bekymring-for-maskinluxe6ring}{%
\subsection{Bekymring for maskinlæring}\label{bekymring-for-maskinluxe6ring}}
